        ...
        <div>
            <div className='w-full h-screen flex flex-col justify-center items-center font-rubik ' >
                <div className='w-5/6 h-5/6 md:w-1/2 md:h-1/2 p-2'>
                    ...
                    <p className="text-lg text-gray-800 text-center">we've sent an email to <span className="font-bold text-gray-700">teyimasobo@gmail.com</span> to verify your email address and activate your account.the link in the email to verify your account.</p>
                </div>
